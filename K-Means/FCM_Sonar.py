...
# 读取数据
sonar = pd.read_csv("C:\\Users\\Gary\\Desktop\\深度学习\\KNN\\sonar.all-data", header=None, sep=',')
...
output_folder = "C:\\Users\\Gary\\Desktop\\深度学习\\K-Means\\KMeans_Images_Sonar_FCM"
...
def fcm():
    # 初始化隶属度矩阵U，随机生成[0, 1]之间的值
    U = np.random.rand(n, k)
    U = U / U.sum(axis=1, keepdims=True)  # 保证每行的和为1
...
def plot_PCA(X, labels, t, output_folder):
    ...
    colors = ((1, 0, 0), (0.33, 0.33, 0.33))  # 红色，灰色
